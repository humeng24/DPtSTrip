...
__all__ = ['ResNet18', 'ResNet34', 'ResNet50', 'ResNet101', 'ResNet18Wide', 'ResNet18Thin']
...
class ResNet(nn.Module):
    ...
    def __init__(self, in_channels, block, num_blocks, wm=1):
        ...
        self.conv1 = nn.Conv2d(in_channels, self.in_planes, kernel_size=3, stride=1,
                               padding=1, bias=False)
...
def ResNet18(input_channels, **kwargs):
    return ResNet(input_channels, BasicBlock, [2, 2, 2, 2], **kwargs)


def ResNet18Wide(input_channels, **kwargs):
    return ResNet(input_channels, BasicBlock, [2, 2, 2, 2], wm=5, **kwargs)


def ResNet18Thin(input_channels, **kwargs):
    return ResNet(input_channels, BasicBlock, [2, 2, 2, 2], wd=.75, **kwargs)


def ResNet34(input_channels, **kwargs):
    return ResNet(input_channels, BasicBlock, [3, 4, 6, 3], **kwargs)


def ResNet50(input_channels, **kwargs):
    return ResNet(input_channels, Bottleneck, [3, 4, 6, 3], **kwargs)


def ResNet101(input_channels, **kwargs):
    return ResNet(input_channels, Bottleneck, [3, 4, 23, 3], **kwargs)
